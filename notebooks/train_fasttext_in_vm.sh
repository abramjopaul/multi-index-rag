...
mkdir -p data/raw/collection/formula/slt_representation_v3

gsutil -m cp -r \
gs://$BUCKET_NAME/data/raw/collection/formula/slt_representation_v3/* \
data/raw/collection/formula/slt_representation_v3/
...
gsutil -m cp -r \
data/formula-indexing/slt/* \
gs://$BUCKET_NAME/models/slt_$TIMESTAMP/
