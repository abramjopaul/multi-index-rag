"""
Symbol Tree data structure for mathematical formulas.
...
class SymbolTree:
    ...
    def get_dot_string(
        self, highlight=None, unified=None, wildcard=None, generic=False
    ):
        ...
        content = (
            " ".join(rank_strings) + " ".join(node_strings) + " ".join(edge_strings)
        )
