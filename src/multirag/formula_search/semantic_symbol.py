"""
Semantic Symbol (OPT) - Operator Tree node representation.

Represents the semantic/operational structure of mathematical formulas, encoding
the mathematical operators and their operands.

Based on TangentCFT (Tangent Combined FastText)
Original repository: https://github.com/BehroozMansouri/TangentCFT

Original authors: Kenny Davila Castellanos, Nidhin Pattaniyil, Richard Zanibbi
